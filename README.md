...
**Bookstore** is a showcase for books.
...
- [Live Demo](https://github.com/gsmalik030/bookstore) [Coming soon]
...
```sh
  cd math-magicians
  git clone https://github.com/gsmalik030/bookstore
```
...
Feel free to check the [issues page](https://github.com/gsmalik030/bookstore/issues).
